// PostDetailPage.jsx
// Right column switches between Post Detail view and an inline Post Editor,
// without leaving the page or changing the route.
// All container sizes/borders/positions remain identical.
...
export default function PostDetailPage() {
  ...
  // Fetch current post (fallback to demo)
  useEffect(() => {
    let aborted = false;
    (async () => {
      try {
            ...
            comments: [
              {
                id: "c1",
                author: "User 1",
                body: "I think I saw one near the info desk earlier today.",
              ...
              },
              {
                ...
                author: "User 2",
                body:
                  "Check the lost & found by the security office. They usually keep umbrellas there.",
